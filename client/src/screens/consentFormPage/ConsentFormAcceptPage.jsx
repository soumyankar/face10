...
export const ConsentFormAcceptPage = () => {
  ...
  useEffect(() => {
    ...
    //   window.location.href = "http://127.0.0.1:5000";
      ...
      navigate("/survey"); // Replace "/target-page" with your desired redirection link
    }, 5000);
  ...
  const handleAnchorClick = () => {
    navigate("/survey"); // Replace "/another-page" with your desired redirection link
  };
